...
app= Flask(__name__)
app.config['UPLOAD_FOLDER']=r"C:\Users\YMTS0519\Documents\APRIL-2022\DISEASE PREDICTION\CODE\DATASET"
app.config['SECRET_KEY']='b0b4fbefdc48be27a6123605f02b6b86'

global data, x_train, x_test, y_train, y_test

TrainData = pd.read_csv('C:\\Users\\YMTS0519\\Documents\\APRIL-2022\\DISEASE PREDICTION\\CODE\\DATASET\\Training.csv')
TestData = pd.read_csv('C:\\Users\\YMTS0519\\Documents\\APRIL-2022\\DISEASE PREDICTION\\CODE\\DATASET\\Testing.csv')
